...
{	
	...
	tankPlayer->mTankImageDirIndex = 0;
	...
	tankPlayer->mBullet.speed[0] = 2;
	tankPlayer->mBullet.speed[1] = 3;
	tankPlayer->mBullet.speed[2] = 3;
	tankPlayer->mBullet.speed[3] = 4;
	tankPlayer->mBullet.bulletSize[0][0] = 4;
	tankPlayer->mBullet.bulletSize[0][1] = 3;
	tankPlayer->mBullet.bulletSize[1][0] = 3;
	tankPlayer->mBullet.bulletSize[1][1] = 4;
	tankPlayer->mBullet.bulletSize[2][0] = 4;
	tankPlayer->mBullet.bulletSize[2][1] = 3;
	tankPlayer->mBullet.bulletSize[3][0] = 3;
	tankPlayer->mBullet.bulletSize[3][1] = 4;
	
	// int bullet_bias[4][2] = { {-BOX_SIZE, -1}, {-2, -BOX_SIZE}, {BOX_SIZE, -1}, {-2, BOX_SIZE} };
	tankPlayer->mBullet.bullet_bias[0][0] = -BOX_SIZE;
	tankPlayer->mBullet.bullet_bias[0][1] = -1;
	tankPlayer->mBullet.bullet_bias[1][0] = -2;
	tankPlayer->mBullet.bullet_bias[1][1] = -BOX_SIZE;
	tankPlayer->mBullet.bullet_bias[2][0] = BOX_SIZE;
	tankPlayer->mBullet.bullet_bias[2][1] = -1;
	tankPlayer->mBullet.bullet_bias[3][0] = -2;
	tankPlayer->mBullet.bullet_bias[3][1] = BOX_SIZE;
	...
	tankPlayer->mMoveSpeedDev[0] = 21;
	tankPlayer->mMoveSpeedDev[1] = 19;
	tankPlayer->mMoveSpeedDev[2] = 17;
	tankPlayer->mMoveSpeedDev[3] = 15;
	
	tankPlayer->mBulletSpeedDev[0] = 17;
	tankPlayer->mBulletSpeedDev[1] = 16;
	tankPlayer->mBulletSpeedDev[2] = 15;
	tankPlayer->mBulletSpeedDev[3] = 14;
}
